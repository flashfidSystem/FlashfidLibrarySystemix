<%@ Page Title="Admin Login" Language="C#" MasterPageFile="~/ProfileMaster/Site1.Master" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="LibrarySystem.Accounts.AdminLogin" %>
     ...
     <div class="row">
         ...
         <div class="card">
             <div class="card-body">
                ...
                <div class="col">
                    <center>
                      <img src="../imgs/images%20(2).jpg" width="150px" height="150px"/>
                    </center>
                       </div>
                    </div>
